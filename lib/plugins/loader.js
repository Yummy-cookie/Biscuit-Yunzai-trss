...
class PluginsLoader {
  ...
  async load(isRefresh = false) {
    ...
    logger.info("-----------")
    logger.info(logger.green(`Yunzai-Bot 开机成功 版本v${cfg.package.version}`))
    logger.info(logger.green("https://gitee.com/Le-niao/Yunzai-Bot"))
    logger.info(logger.green("By https://gitee.com/TimeRainStarSky"))
    logger.info("加载插件中...")
