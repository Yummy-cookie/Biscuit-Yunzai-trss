...
class PluginsLoader {
  ...
  async load(isRefresh = false) {
    ...
    logger.info("-----------")
    logger.info(logger.green(`Biscuit-Bot(TRSS) 开机成功 版本v${cfg.package.version}`))
    logger.info(logger.green("https://gitee.com/Yummy-cookie/Yunzai-Bot/"))
    logger.info(logger.green("By https://gitee.com/Yummy-cookie"))
    logger.info("加载插件中...")
